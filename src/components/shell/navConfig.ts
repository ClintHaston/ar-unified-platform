...
export const NAV: NavItem[] = [
  ...
  { key: 'companies', label: 'Companies', icon: 'company', path: '/companies', section: 'primary' },
  { key: 'buyops', label: 'Buy opps', icon: 'buyops', path: '/buyer-opportunities', buy: true, section: 'primary' },
  {
    ...
    flyout: {
      ...
      items: [
        { label: 'Sell funnel', path: '/reports?tab=sell', icon: 'reports' },
        { label: 'Buy funnel', path: '/reports?tab=buy', icon: 'reports', buy: true },
        { label: 'Deals by rep', path: '/reports?tab=deals', icon: 'deal' },
        { label: 'Calls', path: '/reports?tab=calls', icon: 'contacts' },
        { label: 'Custom builder', path: '/reports?tab=custom', icon: 'reports', sublabel: 'build your own', adminOnly: true },
        { label: 'Dashboards', path: '/reports?tab=dashboards', icon: 'dashboard' },
